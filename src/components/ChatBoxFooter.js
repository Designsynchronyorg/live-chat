...
export default class ChatBoxFooter extends Component {
  ...
  render() {
    return (
      <>
        <MyForm formClass='p-0' shouldDisplayPushNotification={false} shouldDisplayInlineResponse={false} finishSubmitting={this.refreshList} formUrl={MyConfig.apiUrl + "send-message"} validationSchema={{
        ...
        >
          ...
          <div className="flex items-center py-1 px-2 bg-gray-50 rounded-lg dark:bg-gray-700 sm:space-x-2">
            ...
            <FormTextArea hasMessage={false} rows={1} groupClass="grow" inputClasses="rounded-lg py-2 px-2 text-sm dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" id="message" placeholder="Type your message" name="message" />
